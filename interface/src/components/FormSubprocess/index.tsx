...
import { PropsDataProcess, PropsSendDataSubprocess } from "../../interfaces/Process";
...
interface PropsForm{
  id_process?: string;
  resgisterProcess: (data:PropsSendDataSubprocess)=>void;
  data?: PropsDataProcess
}

export function FormSubprocess({id_process, resgisterProcess, data}:PropsForm){
